...
const [selectedCard, setSelectedCard] = React.useState('')
  ...
  return (
    <div className="root">
      ...
      <PopupWithForm name= "edit" title = "Редактировать профиль" nameSubmitBtn="Сохранить" 
      ...
      <input
        ...
        <PopupWithForm name= "add-card" title = "Новое место" nameSubmitBtn="Создать" 
        ...
        <PopupWithForm name= "change-avatar" title = "Обновить аватар" nameSubmitBtn="Сохранить"
        isOpen={isAvatarPopupOpen} onClose={closeAllPopups}>
        <input
              type="url"
              name="link"
        ...
        <PopupWithForm name= "delete-card" title = "Вы уверены?" nameSubmitBtn="Да">
        ...
        <Footer />
        <ImagePopup isOpen={selectedCard} onClose={closeAllPopups} link={selectedCard.link} name={selectedCard.name}></ImagePopup>
